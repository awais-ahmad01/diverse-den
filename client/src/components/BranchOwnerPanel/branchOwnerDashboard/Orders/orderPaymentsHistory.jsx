...
// import PaymentDetailsDialog from "./paymentDetailsDialog";
// // Import the necessary action (assuming you'll create this)
// import { listPaymentHistory } from "../../../../store/actions/orders";

// const OrderPaymentHistory = () => {
//   const dispatch = useDispatch(); // Added dispatch
//   const { user } = useSelector((state) => state.auth);
//   // Get payments from redux state (assuming this will be added to your redux store)
//   const { paymentHistory, isloading, meta } = useSelector((state) => state.orders);
...
//   // Fetch payment history when component mounts - similar to ListOrders
//   useEffect(() => {
//     const business = user?.business;
//     dispatch(listPaymentHistory({ business }))
//       .unwrap()
//       .then(response => {
...
//   // Update filtered payments when payment history changes
//   useEffect(() => {
//     if (paymentHistory) {
...
//       applyDateFilter();
//     }
//   }, [startDate, endDate, paymentHistory]);
...
//   const totalPayments = meta?.totalPayments || 0;
